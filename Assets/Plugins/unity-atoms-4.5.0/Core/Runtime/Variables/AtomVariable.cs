...
namespace UnityAtoms
{
    ...
    {
        public void Установить(ИгровойОбъект игровойОбъект, T данные)
        {
            игровойОбъект.УстановитьДанные(this, данные);
        }
        public T Получить(ИгровойОбъект игровойОбъект)
        {
            return игровойОбъект.ПолучитьДанные<T>(this);
        }
