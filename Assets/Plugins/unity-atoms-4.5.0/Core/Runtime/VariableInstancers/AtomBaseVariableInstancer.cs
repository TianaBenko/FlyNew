...
namespace UnityAtoms
{
    ...
    {
        public abstract AtomBaseVariable GetBase();
        
    }
    public abstract class AtomBaseVariableInstancer<T> : AtomBaseVariableInstancer
    {
    ...
    public abstract class AtomBaseVariableInstancer<T, V> : AtomBaseVariableInstancer<T>, IVariable<V>, IAtomInstancer
        where V : AtomBaseVariable<T>
    {
        public override AtomBaseVariable GetBase() => _base;
        ...
        /// </summary>
        public override T Value { get => _inMemoryCopy.Value; set => _inMemoryCopy.Value = value; }
