...
namespace UnityAtoms
{
    ...
    {
        public abstract AtomEventBase GetBase();
        public abstract void Raise();
    }

    public abstract class AtomEventInstancer<T> : AtomEventInstancer
    {
    ...
    public abstract class AtomEventInstancer<T, E> : AtomEventInstancer<T>, IGetEvent, ISetEvent, IAtomInstancer
        where E : AtomEvent<T>
    {
        ...
        public override AtomEventBase GetBase() => _base;
